...
func main() {
	array := []int{5, 5, 27, 34, 59, 97, 79, 23, 60, 87, 46, 90, 50, 57, 12, 85, 18, 63, 7, 44, 8, 47, 22,
		...
		99, 99, 56, 68, 86, 15, 9, 93, 90, 91, 80, 40, 92, 69, 1, 2, 95, 64, 45, 89, 79, 96, 51, 41, 97, 35, 61, 59, 24, 71, 31, 88, 40, 31, 97, 61, 67, 84, 7, 93, 7, 25,
		...
		4, 81, 56, 33, 58, 70, 78, 49, 29, 68, 11, 22, 13, 57, 45, 64, 100, 99, 38, 71, 18, 8, 46, 86, 86, 21, 3, 32, 83, 12, 63, 88, 32, 100, 78, 63, 97, 17,
	...
	err := os.WriteFile("solved.txt", []byte(output), 0644)
	if err != nil {
